         ...
         <CRow class="justify-content-center">
            ...
            <CCol :md="10" :xs="12">
               ...
               >
                  ...
                  <CCard
                     class="p-4 w-md-50 border-md-end border-1 border-secondary-subtle"
                  >
                     <CForm>
                        <h1>{{ appName }}</h1>
                        <h2>{{ $t('login.title') }}</h2>
                  ...
                  <CCard class="bg-light w-md-50 mt-md-0 mt-3 overflow-auto">
                     ...
                     <CCardBody>
                        <div class="text-center mb-4">
                           <h4
                              v-if="userStore.name"
                              class="mb-2 systems-greeting"
                              tabindex="-1"
                           >
                              {{ $t('systems.greeting') }}, {{ userName }}
                           </h4>
                           <CButton
                              v-if="userStore.name"
                              color="primary"
                        ...
                        <div
                           class="d-flex flex-column gap-3 systems-list"
                           :class="{ 'systems-card-mobile': isMobile }"
                           v-if="userStore.systems.length"
                        >
                           <CCard
