<template>
   <div>
      <CCol :xs="12">
         ...
         <CCard class="mb-4">
            <CCardHeader>
               <span class="smaler">Meu texto</span><br />
               <strong>Vue Table</strong> <small>Basic example xx</small> meu
               texto

               <button><i class="fa fa-chevron-left"></i> Anterior</button>
               <button><i class="fa fa-chevron-right"></i> Próximo</button>
